package com.ultimateninja.pages;

import com.aventstack.extentreports.Status;

import com.ultimateninja.utility.Utility;
...
public class LaptopsAndNotebooksPage extends Utility {
    ...
    public String getVerifyProductMacbook() {
        log.info("Get VerifyProduct Macbook" + getProductMacBookText.toString());
