Feature:  laptops And Note books Page Test
  ...
  Scenario: verify That User Place Order Successfully
    ...
    And enter Name "Devani"
    And enter Last Name"Carli"
    And enter Email "devani123@gmail.com"
    And enter Telephone"1234567890"
    And enter Address"1,kenton road"
    And enter City "Harrow"
    And enter Postcode"HA5 2JB"
    And enter Country "Angola"
